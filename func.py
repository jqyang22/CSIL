...
class load():
    def load_data(self, flag='indian'):
        if flag == 'indian':
            Ind_pines_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/Indian_pines_corrected.mat')
            Ind_pines_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/Indian_pines_gt.mat')
            ...
            categories = 17
        if flag == 'pavia':
            pav_univ_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/PaviaU.mat')
            pav_univ_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/PaviaU_gt.mat')
            ...
            categories = 10
        if flag == 'ksc':
            ksc_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/KSC.mat')
            ksc_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/KSC_gt.mat')
            ...
            categories = 14
        if flag == 'sali':
            salinas_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/Salinas_corrected.mat')
            salinas_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/Salinas_gt.mat')
            ...
            categories = 17
        if flag == 'sali_a':
            salinas_a_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/SalinasA_corrected.mat')
            salinas_a_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/SalinasA_gt.mat')
            ...
            categories = 7
        if flag == 'houston':
            ksc_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/Houston.mat')
            ksc_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/Houston_GT.mat')
            ...
            categories = 16
        if flag == 'hanchuan':
            hc_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/WHU_Hi_HanChuan.mat')
            hc_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/WHU_Hi_HanChuan_gt.mat')
            ...
            categories = 16 + 1
        if flag == 'honghu':
            houston_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/WHU_Hi_HongHu.mat')
            houston_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/WHU_Hi_HongHu_gt.mat')
            ...
            categories = 22 + 1
        if flag == 'longkou':
            hc_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/WHU_Hi_LongKou.mat')
            hc_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/WHU_Hi_LongKou_gt.mat')
        ...
        if flag == 'HU2018':
            ...
            categories = 20+1
        if flag == 'Berlin':
            pav_univ_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI+LiDAR/dataset/HS-SAR Berlin/data_HS_LR.mat')
            pav_univ_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI+LiDAR/dataset/HS-SAR Berlin/gt.mat')

            print(pav_univ_dict['data_HS_LR'].shape)
            print(pav_univ_gt_dict['gt'].shape)

            original = pav_univ_dict['data_HS_LR'].reshape(1723 * 476, 244)
            gt = pav_univ_gt_dict['gt'].reshape(1723 * 476, 1)

            r = pav_univ_dict['data_HS_LR'].shape[0]
            c = pav_univ_dict['data_HS_LR'].shape[1]
            categories = 8 + 1
        if flag == 'paviaC':
            pav_univ_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/Pavia.mat')
            pav_univ_gt_dict = scio.loadmat('/data/jiaqi.yang/Dataset/HSI/Pavia_gt.mat')
        ...
        ######################
        if flag == 'hanchuan' or flag == 'honghu' or flag == 'longkou' or flag == 'Berlin':  # 'All_data' of hanchuan dataset is float, which needs to be changed into int
